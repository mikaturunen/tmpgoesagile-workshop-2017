...
if ! [ -f $UTILITY_DIRECTORY/.hello-world ] ; then 
  ...
  echo 'If you know the Lambda is uploaded, touch utility/hello-world/.hello-world and re-run this script.'
  echo 'If it is not or you are unsure, run the script utility/hello-world/create.sh to upload the Lambda.' 
  exit 1
fi 
...
touch $UTILITY_DIRECTORY/.hello-world
